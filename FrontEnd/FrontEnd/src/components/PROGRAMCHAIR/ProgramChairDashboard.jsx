              ...
              {files.map((file) => (
                <tr key={file._id} className={file.reviewed ? 'table-success' : ''}>
                  ...
                  <td>
                    ...
                    <button
                        onClick={() => forwardFile(file.filepath)}  // Update this to forwardFile or any other relevant function
                        className="btn btn-primary btn-sm mx-1"
                        >
                        <i className="bi bi-arrow-right-circle"></i> Forward  {/* Update the icon to something suitable for 'Forward' */}
                        </button>
                  </td>
                </tr>
              ))}
