...
Senfaculty.get('/uploaded-syllabus', function(req, res) { 
    res.send('Viewed uploaded syllabus');
});

Senfaculty.get('/syllabus-comments', function(req, res) { 
...
Senfaculty.put('/repl-syllabus-comments', function(req, res) { 
